## Get Started
1. **Initial Machine Setup**. First time running the starter kit? Then complete the [Initial Machine Setup](https://github.com/bpc1985/campaign#initial-machine-setup).
2. **Clone the project**. `git clone https://github.com/bpc1985/campaign.git`.
